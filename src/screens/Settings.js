                ...
                <View style={styles.optionsContainer}>
                    {
                        this.state.user ?
                        <View>
                            <Text style={styles.option} onPress={this.handleLogout}>{Language[language].settings.logout}</Text>
                            <Text style={styles.option} onPress={this.handleDeactivate}>{Language[language].settings.deactivate}</Text>
                        </View> :
                        null
                    }
                    <View>
                        <Text style={styles.option} onPress={this.handleLanguageChange}>{Language[language].settings.language}</Text>
                    </View>
                </View>
            </View>
        )
